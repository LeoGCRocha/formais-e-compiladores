...
if __name__ == "__main__":
    ...
    csv_to_table("outputs/csv_files/determinizacao1.csv", "outputs/table_result/determinizacao1.txt")
    automata = t2()
    automata_to_csv("outputs/csv_files/determinizacao2.csv", automata, automata.listOfSymbols())
    csv_to_table("outputs/csv_files/determinizacao2.csv", "outputs/table_result/determinizacao2.txt")
    automata = t1()
    automata_to_csv("outputs/csv_files/determinizacao3.csv", automata, automata.listOfSymbols())
    csv_to_table("outputs/csv_files/determinizacao3.csv", "outputs/table_result/determinizacao3.txt")
    # 3) Union
    automata = t4()
    automata_to_csv("outputs/csv_files/determinizacao4.csv", automata, automata.listOfSymbols())
    csv_to_table("outputs/csv_files/determinizacao4.csv", "outputs/table_result/determinizacao4.txt")